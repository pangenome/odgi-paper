...
MHC=chr6.pan.fa.a2fb268.4030258.d9f1245.smooth.gfa.og
odgi build -g chr6.pan.fa.a2fb268.4030258.d9f1245.smooth.gfa -o "$MHC" -t 28 -P
odgi extract -i "$MHC" -o "$MHC".mhc.og -E -P -t 28 -r grch38#chr6:29000000-34000000
odgi sort -i "$MHC".mhc.og -o "$MHC".mhc.og.O.og -O
odgi layout -i "$MHC".mhc.og.O.og -o "$MHC".mhc.og.O.og.lay -T "$MHC".mhc.og.O.og.lay.tsv -P -t 28 -G 20 -x 100
