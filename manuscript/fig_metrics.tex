\begin{figure}[ht!]
    ...
    \begin{subfigure}{\linewidth}
        ...
        \centering
        % include second image
        \includegraphics[width=1.0\linewidth, trim=-1.75cm 2.2cm -1cm 0.5cm]{fig/metrics/chr4_pan_fa_a2fb268_e820cd3_9ea71d8_smooth_gfa_og_HTTex1_og_O_og_tiny_og_png_svg}
