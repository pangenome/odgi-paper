\begin{figure*}[h!]
	\begin{subfigure}{\linewidth}
		...
		\centering
		% include first image
		\includegraphics[width=1.0\linewidth, trim=0 1cm 0 0]{fig/metrics/chr4_pan_HTTex1_gfa_multiqc_odgi_stats.png}
	...
	\begin{subfigure}{\linewidth}
		...
		\includegraphics[width=1.0\linewidth, trim=0 0.7cm -1cm 0 ]{fig/metrics/chr4_pan_fa_a2fb268_e820cd3_9ea71d8_smooth_gfa_og_HTTex1_og_O_og_tiny_og_png_svg.pdf}
	...
	\begin{subfigure}{\linewidth}
		...
		\centering
		% include second image
		\includegraphics[width=\linewidth,trim=+.225cm 1.4cm +0.425cm +2cm]{fig/metrics/chr4_HTT_chm13_depth_w1_bed.pdf}
	...
	\begin{subfigure}{1\linewidth}
		...
		\includegraphics[width=\linewidth,trim=+.225cm 1.5cm +.425cm +2cm]{fig/metrics/chr4_HTT_chm13_degree_w1_bed.pdf}
