...
On this model, variation graphs add the concept of paths representing linear sequences as traversals through the nodes of the graph~\citep{Garrison:2018}. A path can be a genome, haplotype, contig, or read. [2,5]}
...
\MyStruct{Node}{
    ...
    \textbf{sequence} $= [$A$|$T$|$G$|$C$|$N$]*$ \REVIEWED{[1,2] \tcp{genomic} [1,2]}
