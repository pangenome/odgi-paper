...
Having build a pangenome graph from assemblies in contig state, we can ask questions like: Where do our contigs' ends match the reference(s)? An answer to this question can highlight regions that are tricky to assemble~\ref{fig:odgi_tips}. 
...
\FIXME{add odgi tips figure: only focus on the beta-defensin cluster [p23.3-p22] or more?}
