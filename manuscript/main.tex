...
\begin{document}
    ...
    extensible API that can be used by other tools, e.g., for genotyping,
    pangenome graph building \citep{pggb} and normalization \citep {smoothxg}.
    Future work will add support for RNA and protein sequences and
    expand on metadata capabilities of large pangenome graphs.
