...
\item Paths are similar to each other---in general, sequences from a species pangenome are similar enough to be easily alignable.
...
These properties have already been used to build efficient dynamic variation graph data structures \citep{Eizenga_2020_BX}.
%Here, we build on this work and focus on issues that have arisen during our recent work on the Human Pangenome.
However, we take this work further, focusing on bottlenecks that arose during our work with high-quality assemblies that cover almost all parts of the genome \citep{Logsdon_2021,Nurk_2021}.
