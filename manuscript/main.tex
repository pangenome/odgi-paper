...
ODGI is already the backbone of the pipelines such as the Pangenome Graph Builder~\citep{pggb} and its Nextflow child nf-core/pangenome~\citep{pangenome}. %, where it is also applied for debugging purposes. %\footnote{\url{https://github.com/nf-core/pangenome} (accessed Oct 2021)}.
