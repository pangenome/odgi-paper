...
Edges, and then paths, can be added in parallel by obtaining mutex $Node.lock$ for pairs of nodes and adding the edge or path step their $Node.edges$ and $Node.path\_steps$ vectors.
