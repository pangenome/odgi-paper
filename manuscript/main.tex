...
\item \textit{odgi viz} provides a scalable 1D rendering of the graph (\S\ref{sec:viz}).
...
\item \textit{odgi depth} describes path depth over the graph (\S\ref{sec:metrics}).
