...
\begin{document}
    ...
    \abstract{ \textbf{Motivation:} Pangenomes graphs address some of the
      ...
      structural variants. Hence, fast and versatile software is required to ask intricate questions of such data in an efficient way.
        %
        \\ \textbf{Results:} Here we present \odgi\ a novel range of scalable tools that implements new algorithms and has an efficient in-memory representation of DNA graphs. \odgi\ includes tools for detecting complex regions, extracting \textit{loci}, removing artifacts, exploratory analysis, and graph sorting, manipulation and visualisation. Its fast parallel execution facilitates routine pangenomic tasks as well as pipelines that can quickly answer complex biological questions of very large pangenome graphs.
        %
        \\
        \textbf{Availability:} \odgi\ is \Cpp\ software
        published under the permissive MIT license. Source code and documentation are available at
