...
Because ODGI make use of the GFA file standard its functionality can be mixed with other pangenome tools, such as the VG toolkit~\citep{Garrison:2018}.
...
Similar to other efficient libaries presenting the \red{so-called} \textsc{HandleGraph} model \citep{Eizenga_2020_BX}, ODGI's implementation rests on three key properties which hold for most pangenome variation graphs:
