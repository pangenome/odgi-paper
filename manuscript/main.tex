...
As the GFA format itself does not store metadata information, ODGI follows the PanSN-spec~\citep{pansn-spec} convention for dealing with heterozygosity and polyploidy in the sequence name. This harmonizes the biosample information present in FASTA, VCF, BED, and GFF/GTF formats.
