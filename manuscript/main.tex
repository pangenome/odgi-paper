...
Moreover, to obtain base-level precise information on the relationships between the repeated sequences, we can align them the pairs of regions that came from the untangling to guide the alignment~\citep{wfmash}.
