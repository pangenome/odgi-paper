...
\begin{document}
    ...
    \abstract{ \textbf{Motivation:} Pangenomes graphs address some of the
      ...
      structural variants.
        ...
        manipulation and visualisation. \odgi\ also provides an API that allows
    ...
    orthologs. So-called paths represent contigs that run through the
    nodes. A path can represent an individual chromosome or part
    thereof.  A bi-directed graph can even contain both strands of DNA
    ...
    graph structure in computer memory (RAM) that can be dynamically updated using
    ...
    validate paths respect the graph topology.
