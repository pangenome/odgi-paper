...
%On this model, variation graphs add the concept of path to embed linear sequences (e.g., genomes or haplotypes) into the graph.
%Paths provide a stable coordinate system, and allow the graph to support annotations and  different graphs.
