...
Further investigation of the C4 locus can be performed with \textit{odgi pav} to identify presence/absence variants (PAVs) with respect to one or multiple paths in the pangenome graph (not shown).}
