...
\begin{document}
    ...
    \topic{odgi viz, sort, drawn \& layout} pangenome visualization
    ...
    several algorithms, including the novel `NAME the
    algorithm'. \cmd{odgi layout \& drawn} bring out the consensus
    graph (Fig.~\ref{fig:1}b).
