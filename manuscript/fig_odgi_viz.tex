    ...
    \begin{tabular}[t]{cc}%{|c|c|}
        ...
        \begin{tabular}{c}% if you add [t], then sub images are pushed down
            ...
            \begin{subfigure}[t]{0.5\textwidth}
                \centering
                \caption{}
                \includegraphics[width=\linewidth, trim=0 +1cm -0.5cm 0.5cm]{fig/fig2_extract_viz_draw_position_untangle/chr6_pan_fa_a2fb268_4030258_d9f1245_smooth_gfa_C4_sorted}
            \end{subfigure} \\
            \begin{subfigure}[t]{0.5\textwidth}
                \centering
                \caption{}
                \includegraphics[width=\linewidth, trim=0 +1cm -0.5cm 0.5cm]{fig/fig2_extract_viz_draw_position_untangle/chr6_pan_fa_a2fb268_4030258_d9f1245_smooth_gfa_C4_sorted_du}
            \end{subfigure} \\
            \begin{subfigure}[t]{0.5\textwidth}
                \centering
                \caption{}
                \includegraphics[width=\linewidth, trim=0 +1cm -0.5cm 0.5cm]{fig/fig2_extract_viz_draw_position_untangle/chr6_pan_fa_a2fb268_4030258_d9f1245_smooth_gfa_C4_sorted_z}
            \end{subfigure} \\
            \begin{subfigure}[t]{0.5\textwidth}
                \centering
                \caption{}
                \includegraphics[width=\linewidth, trim=0 +1cm -0.5cm 0.5cm]{fig/fig2_extract_viz_draw_position_untangle/chr6_pan_fa_a2fb268_4030258_d9f1245_smooth_gfa_C4_sorted_m}
            \end{subfigure}
        \end{tabular}
        %&
        \begin{tabular}{c}% if you add [t], than sub images are pushed down
            ...
            \begin{subfigure}[t]{0.5\textwidth}
                \centering
                \includegraphics[width=0.65\linewidth, trim=0 +2cm 0 0.5cm]{fig/fig2_extract_viz_draw_position_untangle/chr6_pan_fa_a2fb268_4030258_d9f1245_smooth_gfa_C4_sorted_layout}
                \caption{}
            \end{subfigure} \\
            \\
...
%        \centering
%        % include first image
%        \includegraphics[width=\linewidth, trim=0 +1.5cm -0.5cm 0.5cm]{fig/fig2_extract_viz_draw_position_untangle/chr6_pan_fa_a2fb268_4030258_d9f1245_smooth_gfa_C4_sorted}
...
%        \includegraphics[width=\linewidth, trim=0 +1.5cm -0.5cm 0.5cm]{fig/fig2_extract_viz_draw_position_untangle/chr6_pan_fa_a2fb268_4030258_d9f1245_smooth_gfa_C4_sorted_du}
...
%        \centering
%        % include second image
%        \includegraphics[width=\linewidth, trim=0 +1.5cm -0.5cm 0.5cm]{fig/fig2_extract_viz_draw_position_untangle/chr6_pan_fa_a2fb268_4030258_d9f1245_smooth_gfa_C4_sorted_z}
...
%        \includegraphics[width=\linewidth, trim=0 +1.5cm -0.5cm 0.5cm]{fig/fig2_extract_viz_draw_position_untangle/chr6_pan_fa_a2fb268_4030258_d9f1245_smooth_gfa_C4_sorted_m}
...
%        \centering
%        % include first image
%        \includegraphics[width=0.5\linewidth, trim=0 +2cm 0 0.5cm]{fig/fig2_extract_viz_draw_position_untangle/chr6_pan_fa_a2fb268_4030258_d9f1245_smooth_gfa_C4_sorted_layout}
...
%        % include second image
%        %todo BANDAGE
%        \includegraphics[width=0.5\linewidth, trim=0 +1.5cm -0.5cm 0.5cm]{fig/fig2_extract_viz_draw_position_untangle/chr6_pan_fa_a2fb268_4030258_d9f1245_smooth_gfa_C4_sorted_layout}
