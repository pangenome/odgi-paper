\begin{figure*}[!htb]
    ...
    \begin{tabular}[t]{cc}%{|c|c|}
        ...
        \begin{subfigure}[t]{1.0\textwidth}
            \centering
            \caption{}
            \includegraphics[width=\linewidth, trim=0cm 0cm -10cm 0cm]{fig/fig_extract_viz_draw_position_untangle/chr6_pan_fa_a2fb268_4030258_d9f1245_smooth_gfa_og_mhc_og_O_og_lay_H1000w100_png_svg}
        \end{subfigure} \\
        ...
        \begin{tabular}{c}% if you add [t], than sub images are pushed down
            ...
            \begin{subfigure}[t]{0.5\textwidth}
                \centering
                \includegraphics[width=0.65\linewidth, trim=0 +2cm 0 0.5cm]{fig/fig_extract_viz_draw_position_untangle/chr6_pan_fa_a2fb268_4030258_d9f1245_smooth_gfa_C4_sorted_bandage}
                \caption{}
            \end{subfigure} \\
            \\
            ...
            \begin{subfigure}[t]{0.5\textwidth}
                \centering
                \includegraphics[width=0.65\linewidth, trim=0 +2cm 0 0.5cm]{fig/fig_extract_viz_draw_position_untangle/chr6_pan_fa_a2fb268_4030258_d9f1245_smooth_gfa_C4_sorted_bandage_zoom_in}
                \caption{}
            \end{subfigure}
        \end{tabular}\\
        \begin{subfigure}[t]{1.0\textwidth}
    ...
    \end{tabular}
    \caption{
        Visualizing the MHC and C4 \textit{loci} pangenome graphs. \textbf{(a)} \textit{odgi draw} layout of the MHC pangenome graph extracted from a whole human pangenome graph of 90 haplotypes. The red rectangle highlights the C4 region.
        ...
        \textbf{(f)} \textit{Bandage} layout of the C4 pangenome graph. Green nodes indicate the C4 genes. The red rectangle highlights the regions where \textit{C4A} and \textit{C4B} genes differ.
        \textbf{(g)} \textit{Bandage} layout of the region where \textit{C4A} and \textit{C4B} genes differ due to single nucleotide variants leading to changes in the encoded protein sequences.
