\begin{figure*}[h!]
    ...
    \begin{subfigure}[b]{.50\linewidth}
        ...
        \centering
        % include first image
        \includegraphics[width=0.5\linewidth, trim=0 +2cm 0 0.5cm]{fig/visualization_1D/chr6_pan_fa_a2fb268_4030258_d9f1245_smooth_gfa_C4_sorted_layout}
    ...
    \begin{subfigure}[b]{.50\linewidth}
        ...
        % include second image
        %todo BANDAGE
        \includegraphics[width=0.5\linewidth, trim=0 +1.5cm -0.5cm 0.5cm]{fig/visualization_1D/chr6_pan_fa_a2fb268_4030258_d9f1245_smooth_gfa_C4_sorted_layout}
