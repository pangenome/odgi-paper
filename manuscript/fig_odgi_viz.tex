\begin{figure*}[!htb]
    ...
    \end{tabular}
    \caption{
        Visualizing the MHC and C4 \textit{loci} pangenome graphs. \textbf{(a)} \textit{odgi draw} layout of the MHC pangenome graph extracted from a whole human pangenome graph of 90 haplotypes. The red box highlights the C4 region.
        ...
        \textbf{(f)} \textit{Bandage} layout of the C4 pangenome graph. The red box highlighs XXX.
        \textbf{(g)} \textit{Bandage} layout of the XXX.
