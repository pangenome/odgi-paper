\begin{figure*}[ht]
    ...
    \begin{minipage}[b]{\textwidth}
        ...
        \caption{Pangenome visualisation of the Major Histocompatibility Complex (MHC) \textit{locus} by \odgi.
          ...
          assemblies, plus the chm13 cell line and GRCh38 reference genome as supplied by the
            ...
            The gene labels are super imposed by \cmd{odgi position} from a GRCh38 BED file and visualised by the Bandage tool~\citep{Wick:2015}.
        }
        \label{fig:1}
        % \end{center}
    \end{minipage}
