\begin{figure*}[!htb]
    ...
    \begin{tabular}[t]{c}%{|c|c|}
        ...
        \begin{subfigure}[t]{1.0\textwidth}
            \centering
            \caption{}
            \includegraphics[width=\linewidth, trim=0cm 18cm -20cm 0.5cm]{fig/extract_viz_draw_position_untangle/chr6_pan_fa_a2fb268_4030258_6a1ecc2_smooth_gfa_og_mhc_og_O_og_lay_H1000w100_png_svg}
        \end{subfigure} \\
    ...
    \caption{
        ...
        The top two reference genomes and 2 haplotypes (HG01952\#2) xgo from left to right, while 5 haplotypes go in the opposite direction, as indicated by the black color on their left.
