\begin{figure*}[!htb]
    ...
    \begin{tabular}[t]{cc}%{|c|c|}
        ...
        \begin{subfigure}[t]{\textwidth}
            \centering
            \caption{}
            \includegraphics[width=\linewidth, trim=0cm 10cm -18cm 0cm]{fig/extract_viz_draw_position_untangle/chr6_pan_fa_a2fb268_4030258_d9f1245_smooth_gfa_og_mhc_og_O_og_lay_H1000w100_png_svg}
        \end{subfigure} \\
